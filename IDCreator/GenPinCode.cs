...
"610622-陕西省延安市延川县"};
            ...
            string temp = _crabodistrict[rnd.Next(0, 2714)];
            district = temp.Substring(0, 6);
            address = temp.Remove(0, 7);          
            ...
            string _pinCode = string.Format("{0}19{1}{2:00}{3:00}{4:000}", district , rnd.Next(50, 92), rnd.Next(1, 12), rnd.Next(1, 30), rnd.Next(1, 600));
            #region Verify
